...
for keyword in keywords[0]:
    ...
    for item in body["items"]:
        ...
        link = item["link"]
        # <b>, </b> 등 html 태그 제거
        description = item["description"].replace("<b>", "")
